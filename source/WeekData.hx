...
class WeekData
{
	...
	public var charaSelect:Array<String> = ['sweet', 'sour'];
	public var weekBackground:String;
	public var weekBefore:String;
	public var storyName:String;
	public var weekName:String;
	public var weekType:String;
	...
	public static function createWeekFile():WeekFile {
		var weekFile:WeekFile = {
			songs: [["Cranberry Pop", "soursweetsad", [146, 113, 253]]],
			weekCharacters: ['Empty', 'Empty', 'Empty', 'Empty'],
			charaSelect: ['sour', 'sweet'],
			weekBackground: 'emptystage',
			weekBefore: 'tutorial',
	...
	public function new(weekFile:WeekFile, fileName:String) {
		...
		weekType = weekFile.weekType;
		location = weekFile.location;
	...
	public static function weekIsLocked(name:String):Bool
	{
		...
		var isLocked:Bool = (!leWeek.startUnlocked && leWeek.weekBefore.length > 0 && (!weekCompleted.exists(leWeek.weekBefore) || !weekCompleted.get(leWeek.weekBefore)));

		// Automatically unlock if in debug mode.
		#if FORCE_DEBUG_VERSION
		if (isLocked) FlxG.log.warn('[WD] ${leWeek.weekName} (${leWeek.fileName}) is normally locked, but forcing unlocked due to debug.');
		return false;
		#else
		return isLocked;
		#end
